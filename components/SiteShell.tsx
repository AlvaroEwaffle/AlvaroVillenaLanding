    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <footer className="border-t border-border bg-[#f6f8f8]">
        <div className="container grid gap-8 py-12 md:grid-cols-3">
          <div>
            <p className="serif text-xl font-bold">Alvaro Villena</p>
            <p className="mt-2 max-w-sm text-sm text-muted">
              Asesor senior de tecnologia y producto. Santiago, Chile. Disponible para proyectos en Chile y LatAm.
            </p>
          </div>
          <div>
            <p className="text-sm font-bold">Servicios</p>
            <div className="mt-3 grid gap-2 text-sm text-muted">
              <Link href="/servicios#diagnostico" className="hover:text-accent">Diagnostico 2 semanas</Link>
              <Link href="/servicios#modernizacion" className="hover:text-accent">Modernizacion acompanada</Link>
              <Link href="/servicios#asesor" className="hover:text-accent">Asesor de tecnologia</Link>
        ...
        <div className="container flex flex-col gap-3 border-t border-border py-5 text-sm text-muted sm:flex-row sm:items-center sm:justify-between">
          <span>© 2026 Alvaro Villena</span>
          <span className="flex gap-4">
            <Link href="/privacidad" className="hover:text-accent">Privacidad</Link>
            <Link href="/terminos" className="hover:text-accent">Terminos</Link>
          </span>
        </div>
      </footer>
    </div>
