...
export const metadata: Metadata = {
  title: 'Contacto',
  description: 'Agenda una llamada de 30 minutos con Álvaro Villena.',
  alternates: { canonical: `${siteUrl}/contacto` },
};

const expectations = [
  ['Minutos 0 a 5', 'Me cuentas qué hace tu empresa y qué te trae a buscar asesoría externa.'],
  ['Minutos 5 a 20', 'Te hago preguntas específicas sobre operación, tecnología, intentos pasados, presupuesto y urgencia real.'],
  ['Minutos 20 a 25', 'Te digo directo si te puedo ayudar o no, y qué modalidad podría calzar.'],
  ['Minutos 25 a 30', 'Definimos próximos pasos concretos si hay interés mutuo. Sin presión.'],
];
  ...
  return (
    <SiteShell>
      <main>
        <section className="section section-blue">
          <div className="container">
            ...
            <p className="mt-5 max-w-3xl text-xl text-muted">
              Una llamada de 30 minutos. Sin presentación de ventas, sin pitch, sin compromiso. Solo una conversación para entender tu situación.
            </p>
          </div>
        </section>
            ...
            <aside className="space-y-6">
              <div className="card p-6">
                ...
                <div className="mt-5 space-y-4 text-muted">
                  <p>
                    Si prefieres contarme por escrito tu situación antes de agendar, escríbeme a{' '}
              ...
              <div className="card p-6">
                ...
                <p className="mt-3 text-muted">
                  Piensa brevemente en qué quieres resolver, qué has intentado antes y qué expectativas tienes. Con eso ganamos tiempo.
                </p>
              </div>
            </aside>
          </div>
        ...
        <section className="section section-blue">
          <div className="container">
            <h2 className="serif text-4xl font-bold">Qué esperar de la primera llamada</h2>
